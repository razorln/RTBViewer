var HTMLRender = (function () {
    function HTMLRender(settings) {
        this.settings = settings;
        this.render();
    }
    HTMLRender.prototype.render = function () {
        var blocks = this.settings.blocks, container = this.settings.renderTo, newBlock, curBlock, box, x, y, i;
    ...
    HTMLRender.prototype.update = function (settings) {
        var blocks = settings.blocks, container = this.settings.renderTo, selBlock, curBlock, box, x, y, i;
    ...
    HTMLRender.prototype.updateBlock = function (curBlock, targetBlock) {
        var curBlock, box, x, y, i;
        if (curBlock.width)
    ...
    HTMLRender.prototype.setHTMLText = function (arrayElems, el) {
        var paragraphsArray = [], newEl, i;
...
var CANVASRender = (function () {
    function CANVASRender(settings) {
        this.settings = settings;
        this.render();
    }
    CANVASRender.prototype.render = function () {
        var blocks = this.settings.blocks, container = this.settings.renderTo, canvas = document.createElement("canvas"), ctx = canvas.getContext("2d"), newBlock, blockWidth, blockHeight, angle, x, y, i;
    ...
    CANVASRender.prototype.update = function (settings) {
        this.settings = settings;
        this.settings.renderTo.innerHTML = "";
        this.render();
    };

    CANVASRender.prototype.setCANVASText = function (arrayElems, ctx, x, y, maxWidth, lineHeight) {
        var paragraphsArray = [], text = "", i;
    ...
    CANVASRender.prototype.wrapText = function (ctx, text, x, y, maxWidth, lineHeight) {
